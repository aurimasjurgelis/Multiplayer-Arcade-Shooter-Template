...
void PixShader(Input input, inout SurfaceOutput o)
{
	...
	float3 delta = float3(1.0 / _TextMeshProUGUIureWidth, 1.0 / _TextMeshProUGUIureHeight, 0.0);
	...
	float2 res = float2(_TextMeshProUGUIureWidth * input.param.y, _TextMeshProUGUIureHeight);
